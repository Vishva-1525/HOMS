import { BarChart3, CalendarDays, FileText, LayoutDashboard, Settings, Smartphone, UserCog, Users } from 'lucide-react'
...
export const adminNav: NavConfig = [
  ...
  { label: 'Account', path: '/admin/account', icon: Smartphone },
