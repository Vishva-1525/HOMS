...
export function DashboardBackground({ children, className, style }: DashboardBackgroundProps) {
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#0D3F72]/52 via-slate-900/38 to-slate-950/48"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(255,255,255,0.22)_0%,_transparent_58%)]"
        aria-hidden
      />
